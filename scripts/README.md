...
This directory contains platform-specific build scripts for simple-ldapd that automate the build and installation process.
...
Deploy and manage Docker containers for simple-ldapd.
...
export CMAKE_INSTALL_PREFIX=/opt/simple-ldapd
./scripts/build-linux.sh
...
# This creates:
# - simple-ldapd-0.1.0-static-linux.tar.gz
# - simple-ldapd-0.1.0-static-macos.tar.gz
# - simple-ldapd-0.1.0-static-windows.zip
```
