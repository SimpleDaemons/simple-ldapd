...
- SASL PLAIN, DIGEST-MD5, EXTERNAL (verified client certificate), and GSSAPI lab tickets from `gssapi_keytab`
...
- `log_level` applied; `bind_rate_limit` per client IP; SASL EXTERNAL requires a verified client certificate
